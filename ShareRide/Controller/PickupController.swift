...
//  ShareRide
//
//  Created by Ramzy Rashaun Arief on 08/05/20.
...
class PickupController: UIViewController {
    ...
    func configureUI() {
        ...
        cancelButton.anchor(top: view.safeAreaLayoutGuide.topAnchor, left: view.leftAnchor, paddingTop: 16, paddingLeft: 20, width: 30, height: 30)
        
        view.addSubview(mapView)
        mapView.setDimensions(height: 270, width: 270)
        mapView.layer.cornerRadius = 270 / 2
        mapView.centerX(inView: view)
        mapView.anchor(top: cancelButton.bottomAnchor, paddingTop: 32)
